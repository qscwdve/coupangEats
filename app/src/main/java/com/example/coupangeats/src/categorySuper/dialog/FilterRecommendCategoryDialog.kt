package com.example.coupangeats.src.categorySuper.dialog
...
class FilterRecommendCategoryDialog(val activity: CategorySuperActivity, val version: Int): BottomSheetDialogFragment() {
